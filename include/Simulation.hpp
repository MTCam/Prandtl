...
namespace Theseus
{
  ...
  // using HLLFlux = HLLFlux::InviscidFlux;
  // using KEPECFlux = ChandrashekarFlux::InviscidFlux;
...
private:
  ...
  std::shared_ptr<Theseus::PhysicsConstants> physicsConstants;
  std::shared_ptr<Theseus::StateLayout> stateLayout;
  std::shared_ptr<Theseus::ActiveGasModel> gasModel;
  ...
  // std::shared_ptr<Theseus::NumericalFlux> numericalFlux;
